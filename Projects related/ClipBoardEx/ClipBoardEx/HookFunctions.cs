...
namespace Correctionary
{
    ...
    public class HookFunctions
    {
        ...
        public void VirtualKeyPressCopy()
        {
            ...
            //mouse_event(LeftDown, Cursor.Position.X, Cursor.Position.Y, 0, 0);
            // mouse_event(LeftUp, Cursor.Position.X, Cursor.Position.Y, 0, 0);
            keybd_event(VK_CONTROL, 0, KEYEVENTF_KEYDOWN | KEYEVENTF_EXTENDEDKEY, 0);
            keybd_event(VK_C, 0, KEYEVENTF_KEYDOWN | KEYEVENTF_EXTENDEDKEY, 0);

            keybd_event(VK_C, 0, KEYEVENTF_KEYUP | KEYEVENTF_EXTENDEDKEY, 0);
